The media developed in the project includes a [PDF file](./dissertation.pdf) and [Markdown file](./dissertation.md). The contents of the Markdown file can also be found below.
