The media developed in the project includes a [PDF file](./note.pdf) and [Markdown file](./note.md). The Markdown file is also included below.
...
- [1 \<Section Title 1\>](#chapter-section-title-1)
  ...
  - [\<Subsection Title 2\>](#section-subsection-title-2)
...
### **Subsection 1.1**: \<Subsection Title 1\>
...
### **Subsection 1.2**: \<Subsection Title 3\>
...
<a id="proof-of-theorem-title-4"></a>
